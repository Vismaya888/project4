...
urlpatterns = [
    ...
    path("n/load-more-suggestions", views.load_more_suggestions, name="load_more_suggestions"),
    path("n/search", views.search, name="search"),
    path("n/edit_profile", views.edit_profile, name="edit_profile"),
    path("n/chat", views.chat_view, name="chat"),
    path("n/chat/<str:username>", views.chat_room, name="chat_room"),
    path("n/messages/<str:username>", views.get_messages, name="get_messages"),
    path("n/send_message", views.send_message, name="send_message"),
    path("n/messages/<str:username>/unread_count", views.get_unread_count, name="unread_count"),
    path("n/messages/unread/total", views.get_total_unread, name="total_unread"),
]
